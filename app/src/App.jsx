...
function App() {
  ...
  const handleSubmit=async ()=>{
    ...
    try {
      const req = await axios.post('https://compilator.onrender.com/api/code', code);
    ...
    <div className="min-h-screen bg-[#1e1e1e] text-gray-200 p-6 font-mono">
      <div className="max-w-4xl mx-auto space-y-4">
        ...
        <textarea
          ...
          rounded-md p-3 focus:outline-nome focus:border-[#007acc]
        ...
        className="w-full h-48 bg-[#1e1e1e] text-[#9cdcfe] border border-[#3c3c3c]
              rounded-md p-3 focus:outline-nome resize-none shadow-inner"
        ></textarea>
